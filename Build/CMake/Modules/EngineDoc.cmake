...
if (CLDOC)
    ...
    get_directory_property(DEFS DIRECTORY ${ENGINE_SOURCE_DIR} COMPILE_DEFINITIONS)
    ...
    SET(doc_args generate ${CXX_LIST} ${C_LIST} -std=c++20 -DENGINE_DEV_BUILD=1 ${DOC_DEFINES} ${DOC_INCLUDES} -- --type html --language c++ --output ${ENGINE_SOURCE_DIR}/Artifacts/Build/EngineDocs)
