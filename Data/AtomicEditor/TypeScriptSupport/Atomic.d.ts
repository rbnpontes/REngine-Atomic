...
declare module Atomic {
   ...
   export enum ProfilerBlockStatus {
       OFF,
       ON,
       FORCE_ON,
       OFF_RECURSIVE,
   ...
   export enum GraphicsClearFlags {
       GRAPHICS_CLEAR_SHADER_PROGRAMS,
   ...
   /** enum ShaderByteCodeType*/
   export enum ShaderByteCodeType {
       Raw,
       SpirV,
       DxB,
       Max
   ...
   export enum Text3DHorizontalAlignment {
       HA_LEFT,
       HA_CENTER,
       HA_RIGHT,
       HA_CUSTOM
   ...
   export enum Text3DVerticalAlignment {
       VA_TOP,
       VA_CENTER,
       VA_BOTTOM,
       VA_CUSTOM
   ...
   export var AM_FILEREADONLY: number;
   ...
   export var PROFILER_DEFAULT_PORT: number;


   export var EP_AUTOLOAD_PATHS: number;
   export var EP_AUTO_METRICS: number;
   export var EP_BORDERLESS: number;
   export var EP_DUMP_SHADERS: number;
   export var EP_EVENT_PROFILER: number;
   export var EP_EXTERNAL_WINDOW: number;
   export var EP_FLUSH_GPU: number;
   export var EP_FORCE_GL2: number;
   export var EP_FRAME_LIMITER: number;
   export var EP_FULL_SCREEN: number;
   export var EP_GRAPHICS_BACKEND: number;
   export var EP_HEADLESS: number;
   export var EP_HIGH_DPI: number;
   export var EP_LOG_LEVEL: number;
   export var EP_LOG_NAME: number;
   export var EP_LOG_QUIET: number;
   export var EP_LOW_QUALITY_SHADOWS: number;
   export var EP_MATERIAL_QUALITY: number;
   export var EP_MONITOR: number;
   export var EP_MULTI_SAMPLE: number;
   export var EP_ORIENTATIONS: number;
   export var EP_PACKAGE_CACHE_DIR: number;
   export var EP_PROFILER_LISTEN: number;
   export var EP_PROFILER_PORT: number;
   export var EP_REFRESH_RATE: number;
   export var EP_RENDER_PATH: number;
   export var EP_RESOURCE_PACKAGES: number;
   export var EP_RESOURCE_PATHS: number;
   export var EP_RESOURCE_PREFIX_PATHS: number;
   export var EP_SHADER_CACHE_DIR: number;
   export var EP_SHADOWS: number;
   export var EP_SOUND: number;
   export var EP_SOUND_BUFFER: number;
   export var EP_SOUND_INTERPOLATION: number;
   export var EP_SOUND_MIX_RATE: number;
   export var EP_SOUND_STEREO: number;
   export var EP_TEXTURE_ANISOTROPY: number;
   export var EP_TEXTURE_FILTER_MODE: number;
   export var EP_TEXTURE_QUALITY: number;
   export var EP_TIME_OUT: number;
   export var EP_TOUCH_EMULATION: number;
   export var EP_TRIPLE_BUFFER: number;
   export var EP_VSYNC: number;
   export var EP_WINDOW_HEIGHT: number;
   export var EP_WINDOW_ICON: number;
   export var EP_WINDOW_MAXIMIZED: number;
   export var EP_WINDOW_POSITION_X: number;
   export var EP_WINDOW_POSITION_Y: number;
   export var EP_WINDOW_RESIZABLE: number;
   export var EP_WINDOW_TITLE: number;
   export var EP_WINDOW_WIDTH: number;
   export var EP_WORKER_THREADS: number;
   ...
   export var MAX_IMMUTABLE_SAMPLERS: number;
   ...
   export var TEXT3D_DEFAULT_FONT_SIZE: number;
   export var TEXT3D_DEFAULT_FONT_TEXTURE_MAX_SIZE: number;
   export var TEXT3D_FONT_DPI: number;
   export var TEXT3D_FONT_TEXTURE_MIN_SIZE: number;
   export var TEXT3D_VERTEX_SIZE: number;
   ...
   export var UIVIEW_DEFAULT_TEXTURE_SIZE: number;
   export var UIVIEW_MAX_TEXTURE_SIZE: number;
   export var UIVIEW_MIN_TEXTURE_SIZE: number;
...
//----------------------------------------------------
   ...
   export class RigidBody2D extends Component {
      ...
      applyLinearImpulseToCenter(impulse: Vector2, wake: boolean): void;
   ...
   export class StaticSprite2D extends Drawable2D {
      ...
      setUseDrawRect(useDrawRect: boolean): void;
      /**  Set whether to use custom-defined texture rectangle. */
      setUseTextureRect(useTextureRect: boolean): void;
      /**  Set hot spot. */
      setHotSpot(hotspot: Vector2): void;
      /**  Set custom material. */
   ...
   export class TmxTileLayer2D extends TmxLayer2D {
    ...
    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "ParticlesEnd" **/
    export var ParticlesEndEventType : Atomic.EventType;

    /** object returned in the callback for the ParticlesEnd event.**/
    export interface ParticlesEndEvent extends Atomic.EventData {
        node : Atomic.Node;
        effect : Atomic.ParticleEffect2D;
    }

    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the ParticlesEnd event. 

     / Emitting ParticleEmitter2D particles stopped.
    **/
    export function ParticlesEndEvent (callback : Atomic.EventCallback<ParticlesEndEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the ParticlesEnd event. **/ 
    export function ParticlesEndEventData (callbackData : ParticlesEndEvent) : Atomic.EventCallbackMetaData; 


    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "ParticlesDuration" **/
    export var ParticlesDurationEventType : Atomic.EventType;

    /** object returned in the callback for the ParticlesDuration event.**/
    export interface ParticlesDurationEvent extends Atomic.EventData {
        node : Atomic.Node;
        effect : Atomic.ParticleEffect2D;
    }

    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the ParticlesDuration event. 

     / All ParticleEmitter2D particles have been removed.
    **/
    export function ParticlesDurationEvent (callback : Atomic.EventCallback<ParticlesDurationEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the ParticlesDuration event. **/ 
    export function ParticlesDurationEventData (callbackData : ParticlesDurationEvent) : Atomic.EventCallbackMetaData; 


    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "PhysicsUpdateContact2D" **/
    export var PhysicsUpdateContact2DEventType : Atomic.EventType;

    /** object returned in the callback for the PhysicsUpdateContact2D event.**/
    export interface PhysicsUpdateContact2DEvent extends Atomic.EventData {
        world : Atomic.PhysicsWorld2D;
        bodyA : Atomic.RigidBody2D;
        bodyB : Atomic.RigidBody2D;
        nodeA : Atomic.Node;
        nodeB : Atomic.Node;
        /**  containing position Vector2, normal Vector2, negative overlap distance float. Normal is the same for all points. */
        /** Unmapped Native Type: Buffer */
        contacts : any;
        shapeA : Atomic.CollisionShape2D;
        shapeB : Atomic.CollisionShape2D;
        enabled : boolean;
    }

    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the PhysicsUpdateContact2D event. 

     / Physics update contact. Global event sent by PhysicsWorld2D.
    **/
    export function PhysicsUpdateContact2DEvent (callback : Atomic.EventCallback<PhysicsUpdateContact2DEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the PhysicsUpdateContact2D event. **/ 
    export function PhysicsUpdateContact2DEventData (callbackData : PhysicsUpdateContact2DEvent) : Atomic.EventCallbackMetaData; 
    ...
    **/
    ...
    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "NodeUpdateContact2D" **/
    export var NodeUpdateContact2DEventType : Atomic.EventType;

    /** object returned in the callback for the NodeUpdateContact2D event.**/
    export interface NodeUpdateContact2DEvent extends Atomic.EventData {
        ...
        /** Unmapped Native Type: Buffer */
        contacts : any;
        shape : Atomic.CollisionShape2D;
        otherShape : Atomic.CollisionShape2D;
        enabled : boolean;
    }

    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the NodeUpdateContact2D event. 

     / Node update contact. Sent by scene nodes participating in a collision.
    **/
    export function NodeUpdateContact2DEvent (callback : Atomic.EventCallback<NodeUpdateContact2DEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the NodeUpdateContact2D event. **/ 
    export function NodeUpdateContact2DEventData (callbackData : NodeUpdateContact2DEvent) : Atomic.EventCallbackMetaData; 
...
//----------------------------------------------------
   ...
   export class Sound extends ResourceWithMetadata {
...
//----------------------------------------------------
   ...
   export class Context extends RefCounted {
      ...
      requireSDL(sdlFlags: number): boolean;
   ...
   export class Profiler extends AObject {

      enabled: boolean;
      eventProfilingEnabled: boolean;
      listening: boolean;
      eventTracingEnabled: boolean;
      lowPriorityEventTracing: boolean;
      ...
      setEventProfilingEnabled(enabled: boolean): void;
      /**  Returns true if event profiling is enabled, false otherwise. */
      getEventProfilingEnabled(): boolean;
...
//----------------------------------------------------
   ...
   export class Animation extends ResourceWithMetadata {
      ...
      getKeyFramePositionAtIndex(name: string, keyIndex: number): Vector3;
   ...
   export class DebugRenderer extends Component {
      ...
      setLineAntiAlias(enable: boolean): void;
      ...
      /**  Add a bounding box. */
      addBoundingBox(box: BoundingBox, color: Color, depthTest?: boolean, solid?: boolean): void;
      /**  Add a frustum. */
   ...
   export class DecalSet extends Drawable {
      ...
      setOptimizeBufferSize(enable: boolean): void;
   ...
   export class Graphics extends AObject {
      ...
      setShaderCacheDir(path: string): void;
      ...
      getDesktopResolution(monitor: number): IntVector2;
      ...
      static getTextureUnit(name: string): TextureUnit;
   ...
   export class Model extends ResourceWithMetadata {
   ...
   export class RenderPath extends RefCounted {
      ...
      getCommand(index: number, dst: RenderPathCommand): boolean;
      /**  Sets the render command at specified index */
      setCommand(index: number, src: RenderPathCommand): boolean;
   ...
   export class RenderSurface extends RefCounted {
      ...
      createRenderBuffer(width: number, height: number, format: number, multiSample: number): boolean;
      /**  Return width. */
      getWidth(): number;
      /**  Return height. */
      getHeight(): number;
      ...
      isResolveDirty(): boolean;
      /**  Set or clear the need resolve flag. Called internally by Graphics. */
      setResolveDirty(enable: boolean): void;
   ...
   export class Renderer extends AObject {
      ...
      setVSMMultiSample(multiSample: number): void;
      ...
      getDummyTexture(): Texture2D;
      /**  Return the dummy texture cube. */
      getDummyTextureCube(): TextureCube;
      /**  Return correct dummy texture for a given unit type. */
      getSuitableDummyTexture(unit_type: TextureUnitType): Texture;
      ...
      getScreenBuffer(width: number, height: number, format: number, multiSample: number, autoResolve: boolean, cubemap: boolean, filtered: boolean, srgb: boolean, persistentKey?: number): Texture;
      /**  Allocate a depth-stencil surface that does not need to be readable. Should only be called during actual rendering, not before. */
      getDepthStencil(width: number, height: number, multiSample: number, autoResolve: boolean): RenderSurface;
   ...
   export class Terrain extends Component {
      ...
      heightMapToWorld(pixelPosition: IntVector2): Vector3;
   ...
   export class Text3D extends Drawable {

      updateGeometryType: UpdateGeometryType;
      material: Material;
      text: string;
      horizontalAlignment: Text3DHorizontalAlignment;
      verticalAlignment: Text3DVerticalAlignment;
      textAlignment: Text3DHorizontalAlignment;
      rowSpacing: number;
      wordwrap: boolean;
      textEffect: Text3DTextEffect;
      effectShadowOffset: IntVector2;
      effectStrokeThickness: number;
      effectRoundStroke: boolean;
      effectColor: Color;
      effectDepthBias: number;
      width: number;
      opacity: number;
      fixedScreenSize: boolean;
      faceCameraMode: FaceCameraMode;
      ...
      setAlignment(hAlign: Text3DHorizontalAlignment, vAlign: Text3DVerticalAlignment): void;
      /**  Set horizontal alignment. */
      setHorizontalAlignment(align: Text3DHorizontalAlignment): void;
      /**  Set vertical alignment. */
      setVerticalAlignment(align: Text3DVerticalAlignment): void;
      /**  Set row alignment. */
      setTextAlignment(align: Text3DHorizontalAlignment): void;
      /**  Set row spacing, 1.0 for original font spacing. */
      setRowSpacing(spacing: number): void;
      /**  Set wordwrap. In wordwrap mode the text element will respect its current width. Otherwise it resizes itself freely. */
      setWordwrap(enable: boolean): void;
      /**  Set text effect. */
      setTextEffect(textEffect: Text3DTextEffect): void;
      /**  Set shadow offset. */
      setEffectShadowOffset(offset: IntVector2): void;
      /**  Set stroke thickness. */
      setEffectStrokeThickness(thickness: number): void;
      /**  Set stroke rounding. Corners of the font will be rounded off in the stroke so the stroke won't have corners. */
      setEffectRoundStroke(roundStroke: boolean): void;
      /**  Set effect color. */
      setEffectColor(effectColor: Color): void;
      /**  Set effect Z bias. */
      setEffectDepthBias(bias: number): void;
      ...
      getTextAlignment(): Text3DHorizontalAlignment;
      /**  Return horizontal alignment. */
      getHorizontalAlignment(): Text3DHorizontalAlignment;
      /**  Return vertical alignment. */
      getVerticalAlignment(): Text3DVerticalAlignment;
      /**  Return row spacing. */
      getRowSpacing(): number;
      /**  Return wordwrap mode. */
      getWordwrap(): boolean;
      /**  Return text effect. */
      getTextEffect(): Text3DTextEffect;
      /**  Return effect shadow offset. */
      getEffectShadowOffset(): IntVector2;
      /**  Return effect stroke thickness. */
      getEffectStrokeThickness(): number;
      /**  Return effect round stroke. */
      getEffectRoundStroke(): boolean;
      /**  Return effect color. */
      getEffectColor(): Color;
      /**  Return effect depth bias. */
      getEffectDepthBias(): number;
      /**  Return text width. */
      getWidth(): number;
      /**  Return text height. */
      getHeight(): number;
      ...
      getRowWidth(index: number): number;
      /**  Return position of character by index relative to the text element origin. */
      getCharPosition(index: number): Vector2;
      /**  Return size of character by index. */
      getCharSize(index: number): Vector2;
      /**  Return corner color. */
      getColor(corner: Text3DCorner): Color;
      /**  Return opacity. */
      getOpacity(): number;
   ...
   export class Text3DFont extends Resource {

      absoluteGlyphOffset: IntVector2;
      scaledGlyphOffset: Vector2;
      fontType: Text3DFontType;
      sDFFont: boolean;
   ...
   export class Texture extends ResourceWithMetadata {

      unitType: TextureUnitType;
      numLevels: number;
   ...
   export class TextureCube extends Texture {
      ...
      getImage(face: CubeMapFace): Image;
      /**  Return render surface for one face. */
      getRenderSurface(face: CubeMapFace): RenderSurface;
      static createFrom(texture: Texture2D): TextureCube;
    ...
    **/
    ...
    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "ViewBuffersReady" **/
    export var ViewBuffersReadyEventType : Atomic.EventType;

    /** object returned in the callback for the ViewBuffersReady event.**/
    export interface ViewBuffersReadyEvent extends Atomic.EventData {
        view : Atomic.View;
        texture : Atomic.Texture;
        surface : Atomic.RenderSurface;
        scene : Atomic.Scene;
    ...
    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the ViewBuffersReady event. 

     / A view has allocated its screen buffers for rendering. They can be accessed now with View::FindNamedTexture().
    **/
    export function ViewBuffersReadyEvent (callback : Atomic.EventCallback<ViewBuffersReadyEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the ViewBuffersReady event. **/ 
    export function ViewBuffersReadyEventData (callbackData : ViewBuffersReadyEvent) : Atomic.EventCallbackMetaData; 


    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "ViewGlobalShaderParameters" **/
    export var ViewGlobalShaderParametersEventType : Atomic.EventType;

    /** object returned in the callback for the ViewGlobalShaderParameters event.**/
    export interface ViewGlobalShaderParametersEvent extends Atomic.EventData {
        view : Atomic.View;
        texture : Atomic.Texture;
        surface : Atomic.RenderSurface;
        scene : Atomic.Scene;
    ...
    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the ViewGlobalShaderParameters event. 
    ...
    **/
    export function ViewGlobalShaderParametersEvent (callback : Atomic.EventCallback<ViewGlobalShaderParametersEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the ViewGlobalShaderParameters event. **/ 
    export function ViewGlobalShaderParametersEventData (callbackData : ViewGlobalShaderParametersEvent) : Atomic.EventCallbackMetaData; 
    ...
    **/
    ...
    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "EndAllViewsRender" **/
    export var EndAllViewsRenderEventType : Atomic.EventType;

    /** object returned in the callback for the EndAllViewsRender event.**/
    export interface EndAllViewsRenderEvent extends Atomic.EventData {
    }

    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the EndAllViewsRender event. 

     / Render of all views is finished for the frame.
    **/
    export function EndAllViewsRenderEvent (callback : Atomic.EventCallback<EndAllViewsRenderEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct object to pass to 'sendEvent' for the EndAllViewsRender event. **/ 
    export function EndAllViewsRenderEventData () : Atomic.EventCallbackMetaData; 
...
//----------------------------------------------------
   ...
   export class BufferQueue extends AObject {
      ...
      seekRelative(delta: number): number;
   ...
   export class FileNameIterator extends RefCounted {
...
//----------------------------------------------------
    ...
    **/
    ...
    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "TextEditing" **/
    export var TextEditingEventType : Atomic.EventType;

    /** object returned in the callback for the TextEditing event.**/
    export interface TextEditingEvent extends Atomic.EventData {
        composition : string;
        cursor : number;
    ...
    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the TextEditing event. 

     / Text editing event.
    **/
    export function TextEditingEvent (callback : Atomic.EventCallback<TextEditingEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the TextEditing event. **/ 
    export function TextEditingEventData (callbackData : TextEditingEvent) : Atomic.EventCallbackMetaData; 
...
//----------------------------------------------------
   ...
   export class MetricsSnapshot extends RefCounted {
      ...
      registerInstance(classname: string, instantiationType: InstantiationType, count?: number): void;
...
//----------------------------------------------------
   ...
   export class DynamicNavigationMesh extends NavigationMesh {
      ...
      allocate(boundingBox: BoundingBox, maxTiles: number): boolean;
      /**  Return whether the Obstacle is touching the given tile. */
      isObstacleInTile(obstacle: Obstacle, tile: IntVector2): boolean;
      /**  Remove tile from navigation mesh. */
      removeTile(tile: IntVector2): void;
   ...
   export class NavigationMesh extends Component {
      ...
      hasTile(tile: IntVector2): boolean;
      /**  Return bounding box of the tile in the node space. */
      getTileBoudningBox(tile: IntVector2): BoundingBox;
      /**  Return index of the tile at the position. */
      getTileIndex(position: Vector3): IntVector2;
    ...
    **/
    ...
    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "NavigationTileAdded" **/
    export var NavigationTileAddedEventType : Atomic.EventType;

    /** object returned in the callback for the NavigationTileAdded event.**/
    export interface NavigationTileAddedEvent extends Atomic.EventData {
        node : Atomic.Node;
        mesh : Atomic.NavigationMesh;
        tile : Atomic.IntVector2;
    }

    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the NavigationTileAdded event. 

     / Mesh tile is added to navigation mesh.
    **/
    export function NavigationTileAddedEvent (callback : Atomic.EventCallback<NavigationTileAddedEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the NavigationTileAdded event. **/ 
    export function NavigationTileAddedEventData (callbackData : NavigationTileAddedEvent) : Atomic.EventCallbackMetaData; 


    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "NavigationTileRemoved" **/
    export var NavigationTileRemovedEventType : Atomic.EventType;

    /** object returned in the callback for the NavigationTileRemoved event.**/
    export interface NavigationTileRemovedEvent extends Atomic.EventData {
        node : Atomic.Node;
        mesh : Atomic.NavigationMesh;
        tile : Atomic.IntVector2;
    }
    ...
    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the NavigationTileRemoved event. 

     / Mesh tile is removed from navigation mesh.
    **/
    export function NavigationTileRemovedEvent (callback : Atomic.EventCallback<NavigationTileRemovedEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the NavigationTileRemoved event. **/ 
    export function NavigationTileRemovedEventData (callbackData : NavigationTileRemovedEvent) : Atomic.EventCallbackMetaData; 


    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "NavigationAllTilesRemoved" **/
    export var NavigationAllTilesRemovedEventType : Atomic.EventType;

    /** object returned in the callback for the NavigationAllTilesRemoved event.**/
    export interface NavigationAllTilesRemovedEvent extends Atomic.EventData {
        node : Atomic.Node;
        mesh : Atomic.NavigationMesh;
    }

    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the NavigationAllTilesRemoved event. 

     / All mesh tiles are removed from navigation mesh.
    **/
    export function NavigationAllTilesRemovedEvent (callback : Atomic.EventCallback<NavigationAllTilesRemovedEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the NavigationAllTilesRemoved event. **/ 
    export function NavigationAllTilesRemovedEventData (callbackData : NavigationAllTilesRemovedEvent) : Atomic.EventCallbackMetaData; 
...
//----------------------------------------------------
   ...
   export class Image extends Resource {
      ...
      saveWEBP(fileName: string, compression?: number): boolean;
   ...
   export class ResourceCache extends AObject {
      ...
      printResources(typeName?: string): string;
   ...
   export class ResourceWithMetadata extends Resource {
...
//----------------------------------------------------
   ...
   export class Node extends Animatable {
      ...
      createChild(name?: string, mode?: CreateMode, id?: number, temporary?: boolean): Node;
      /**  Create a temporary child scene node (with specified ID if provided). */
      createTemporaryChild(name?: string, mode?: CreateMode, id?: number): Node;
      ...
      setVarFromString(name: string, vartype: string, value: string): void;
      /**  an empty string is returned if the entry name is not present. */
      getVarAsString(name: string): string;
      /**  returns true if present, returns false if it is not present. */
      isVar(name: string): boolean;
      /**  an empty string is returned if the entry name is not present. */
...
//----------------------------------------------------
   ...
   export class RenderPathCommand extends RefCounted {
   ...
   export class ScriptVariantMap extends RefCounted {
      ...
      getIntVector2(key: string): IntVector2;
...
//----------------------------------------------------
   ...
   export class UI extends AObject {
      ...
      debugHudRefreshInterval: number;
   ...
   export class UIButtonGrid extends UIWidget {
   ...
   export class UIDockWindow extends UIWindow {

      dockOrigin: string;
      dockContent: UIWidget;
      axis: UI_AXIS;

      /**  minheight is the minimum height for the UIDockWindow */
      constructor(createWidget?: boolean, title?: string, contentptr?: UIWidget, minwidth?: number, minheight?: number);

      setDockOrigin(dockid: string): void;
      /**  ID of the redock widget. If specified, pressing the dock button, will move the content there. */
      getDockContent(): UIWidget;
      /**  This returns a pointer to the docked content. */
      hasDockContent(): boolean;
      /**  Returns if the UIDockWindow contains docked content. */
      dock(target: UIWidget): void;
      /**  Transfers the dock content to the target widget */
      show(host: UIWidget, xpos?: number, ypos?: number): void;
   ...
   export class UIFinderWindow extends UIWindow {

      constructor(target: UIWidget, id: string, createWidget?: boolean);

      findFile(title: string, preset: string, dimmer?: number, width?: number, height?: number): void;
      findPath(title: string, preset: string, dimmer?: number, width?: number, height?: number): void;
   ...
   export class UILayout extends UIWidget {
      ...
      setLayoutConfig(settings: string): void;
   ...
   export class UIMultiItem extends UISelectItem {

      id: string;
      numColumns: number;

      constructor(colid: string, widgettype: string, str: string, colwidth: number, colheight: number);

      setID(id: string): void;
      addColumn(widgettype: string, str: string, colwidth: number): void;
      getColumnStr(col: number): string;
      getColumnWidget(col: number): string;
      getColumnWidth(col: number): number;
      getNumColumns(): number;

   }

   export class UIMultiItemSource extends UISelectItemSource {

      itemCount: number;

      constructor();

      addItem(item: UIMultiItem): void;
   ...
   export class UIPromptWindow extends UIWindow {

      constructor(target: UIWidget, id: string, createWidget?: boolean);

      show(title: string, message: string, preset: string, dimmer?: number, width?: number, height?: number): void;

   }

   export class UIPulldownMenu extends UIButton {
   ...
   export class UIRadioButton extends UIWidget {
   ...
   export class UIScrollBar extends UIWidget {
      ...
      setLimits(minimum: number, maximum: number, visible: number): void;
      getMinValue(): number;
      getMaxValue(): number;
      getVisible(): number;
   ...
   export class UITabContainer extends UIWidget {
      ...
      addTabPageFile(tabname: string, layoutFile: string, selecttab?: boolean): void;
      /**  adds a tab + page from file */
      addTabPageWidget(tabname: string, widget: UIWidget, selecttab?: boolean): void;
      undockPage(page: number): void;
      /**  undocks the page into a window with the tab name, and removes the tab */
      dockWindow(windowTitle: string): boolean;
   ...
   export class UIView extends UIWidget {
      ...
      /**  Set the view size */
      setSizeInPixels(width: number, height: number): boolean;
      ...
      setRenderToTexture(value: boolean, width?: number, height?: number): boolean;
   ...
   export class UIWidget extends AObject {
      ...
      setPositionInPixels(x: number, y: number): void;
      setText(text: string): void;
      ...
      setFontSizeInPixels(size: number): void;
      getFontSize(): number;
      getFontSizeInPixels(): number;
      setX(x: number): void;
      setXInPixels(x: number): void;
      getX(): number;
      getXInPixels(): number;
      setY(y: number): void;
      setYInPixels(y: number): void;
      getY(): number;
      getYInPixels(): number;
      setWidth(width: number): void;
      setWidthInPixels(width: number): void;
      getWidth(): number;
      getWidthInPixels(): number;
      setHeight(height: number): void;
      setHeightInPixels(height: number): void;
      getHeight(): number;
    ...
    **/
    ...
    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "UIPromptComplete" **/
    export var UIPromptCompleteEventType : Atomic.EventType;

    /** object returned in the callback for the UIPromptComplete event.**/
    export interface UIPromptCompleteEvent extends Atomic.EventData {
        title : string;
        reason : string;
        selected : string;
    }
    ...
    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the UIPromptComplete event. 

     / event for PromptWindow
    **/
    export function UIPromptCompleteEvent (callback : Atomic.EventCallback<UIPromptCompleteEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the UIPromptComplete event. **/ 
    export function UIPromptCompleteEventData (callbackData : UIPromptCompleteEvent) : Atomic.EventCallbackMetaData; 


    /** Event type to use in calls requiring the event such as 'sendEvent'.  Event Type is: "UIFinderComplete" **/
    export var UIFinderCompleteEventType : Atomic.EventType;

    /** object returned in the callback for the UIFinderComplete event.**/
    export interface UIFinderCompleteEvent extends Atomic.EventData {
        title : string;
        reason : string;
        selected : string;
    }
    ...
    /**
     Wrapper function to generate a properly formatted event handler to pass to 'subscribeToEvent' for the UIFinderComplete event. 

     / event for FinderWindow
    **/
    export function UIFinderCompleteEvent (callback : Atomic.EventCallback<UIFinderCompleteEvent>) : Atomic.EventMetaData;

    /** Wrapper function to construct callback data to pass to 'sendEvent' for the UIFinderComplete event. **/ 
    export function UIFinderCompleteEventData (callbackData : UIFinderCompleteEvent) : Atomic.EventCallbackMetaData; 
...
declare module AtomicApp {
   ...
   export enum PlayerLaunchMode {
       PLAYER_LAUNCH_STANDALONE,
...
//----------------------------------------------------
   ...
   export class AppBase extends Atomic.Application {
      ...
      static getDebuggerAttached(): boolean;
   ...
   export class IPCServerApp extends AppBase {
      ...
      setup(): void;
      stop(): void;
      runIPCClient(projectName: string, projectPath: string, addArgs: string): boolean;
      requestTogglePlayerUpdatesPaused(): void;
      requestPlayerPauseStep(): void;
   ...
   export class PlayerApp extends AppBase {
      ...
      static getLaunchMode(): PlayerLaunchMode;
...
//----------------------------------------------------
   ...
   export class AssetDatabase extends Atomic.AObject {
      ...
      generateCache(clean?: boolean): boolean;
