...
namespace REngine
{
	...
	struct TextureManagerStgCreateInfo
	{
		u16 width;
		u16 height;
		Atomic::TextureFormat format;
	...
	Diligent::RefCntAutoPtr<Diligent::ITexture> texture_manager_tex2d_get_stg(const TextureManagerStgCreateInfo& create_info);
